...
class _MembershipScreenState extends State<MembershipScreen> {
  ...
  Future<void> checkMembershipStatus(String email, String membershipId,
      String membershipName, String membershipPrice) async {
    final url =
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        _showInfoDialog(
            "Error", "Unable to check membership status. Please try again.");
      }
    } catch (e) {
      log("Error: $e");
      _showInfoDialog(
