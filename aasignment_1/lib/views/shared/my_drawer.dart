...
class _MyDrawerState extends State<MyDrawer> {
 ...
 Widget build(BuildContext context) {
          ...
          children: [
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('assets/images/orange_bg.avif'), // Replace with your image path
                  fit: BoxFit.cover,
                ),
              ),
            ),
            Container(
              ...
              decoration: BoxDecoration(
                color: Colors.black.withOpacity(0.2), // Add a dark overlay for better contrast
              ),
            ),
            Positioned(
              bottom: 20,
          ...
          child: ListView(
            children: [
              ...
              ListTile(
                ...
                onTap: () {
                  // Navigator.push(context, MaterialPageRoute(builder: (content) => EventScreen()));
                },
              ),
              const ListTile(
  ...
  try {
    ...
    String url = "${Myconfig.servername}/memberlink_asg1/api/get_user_name.php";
